...
#define STEPPER2_STEP_GPIO_Port GPIOE
#define STEPPER2_LIMIT_Pin GPIO_PIN_11
#define STEPPER2_LIMIT_GPIO_Port GPIOE
...
#define STEPPER1_DIR_Pin GPIO_PIN_15
...
#define STEPPER1_LIMIT_Pin GPIO_PIN_15
#define STEPPER1_LIMIT_GPIO_Port GPIOG
